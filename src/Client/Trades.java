...
//     *
//     * @param organisation Instance of the Units class
//     * @param user Instance of the User class
//     */
//    public Trades(Units organisation, User user) {
...
//        // Gets the instance of the Units associated with the user from the list of all
//        // Organisations
//        Units listingOrganisation = new Units();
//        listingOrganisation = org.getOrganisation(org.getOrganisationList(),
//                users.getUnitName(username));
//
...
//        ArrayList<String> tradeSell = multiValueMap.get(tradeID2);
//
//        // Gets Units object associated with the user who created the Buy listing
//        Units orgBuyer = org.getOrganisation(org.getOrganisationList(),
//                tradeBuy.get(orgName));
//
//        // Gets Units object associated with the user who created the Sell listing
//        Units orgSeller = org.getOrganisation(org.getOrganisationList(),
...
//        int currentCredits;
//
//        // Gets Units object associated with the user who is cancelling the trade
//        Units orgCancel = org.getOrganisation(org.getOrganisationList(),
