...
public class AllListingsTableBuy extends JFrame {
    JTable buyTable;


    public AllListingsTableBuy(JPanel panel, ServerAPI server) {
        ...
        HashMap<Integer, String[]> buyTrades = server.getTradesByType("buy");
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder("Current Buy Listings"));
